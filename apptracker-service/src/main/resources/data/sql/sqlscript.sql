...
CREATE TABLE `contract_info` (
  ...
  `FORMAER_WORKER` int(11) DEFAULT NULL,
  ...
  `US_ARMED_FORCES` int(11) DEFAULT NULL,
  `REGISTERED_NOTARY_PUBLIC` int(11) DEFAULT NULL,
  `CSI_INFO_ACCESS` int(11) DEFAULT NULL,
  `candidate_referred_to_you` int(11) DEFAULT NULL,
  `REFERRAL_ORIGINATE` varchar(100) DEFAULT NULL,
  `candiate_seleted_within_guidelines` int(11) DEFAULT NULL,
